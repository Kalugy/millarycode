    ...
    <div className="container mx-auto px-4 md:flex md:justify-center md:items-center">
      ...
      <div className="mb-6 md:mb-0">
        ...
        <div className="flex space-x-4 justify-center">
          <SocialIcon path="M18 2H15a5 5 0 00-5 5v3H7v4h3v8h4v-8h3.72l.78-4H14V7a1 1 0 011-1h3z" color="#1877F2" />
          <SocialIcon path="M23 3a10.9 10.9 0 01-3.14 1.53A4.48 4.48 0 0016 3a4.48 4.48 0 00-4.48 4.48c0 .35.04.7.11 1.03A12.94 12.94 0 013 4s-4 9 5 13a13.34 13.34 0 01-7 2c9 5 20-1 20-11.5a4.48 4.48 0 00-.08-.83A10.18 10.18 0 0023 3z" color="#1DA1F2" />
